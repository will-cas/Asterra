...
namespace Asterra.Gameplay
{
    ...
    public static class AiMacroSelfTest
    {
        ...
        private static bool PlacesFirstProducer()
        {
            ...
            float keepZ = 80f;
            sim.SpawnBuilding(
                ids.Next(), ai, new FactionId(1), FactionDefaultContent.OutcastGreatCampId, keepX, keepZ, startActive: true);
            sim.SpawnUnit(
                ids.Next(), ai, new FactionId(1), FactionDefaultContent.OutcastBuilderId, keepX + 8f, keepZ + 8f);
